...
const statsData: StatItem[] = [
  ...
  },
  {
    id: 2,
    number: "100K",
    text: "Мы собрали десятки отзывов от клиентов и более 100 тысяч <br /> отзывов от их <br /> пользователей.",
    ...
    <section className={styles.about}>
      <div className={styles.container}>
        ...
        <div className={styles.hero}>
          <h2 className={styles.heroTitle}>Мы стремимся к инновациям</h2>
          <button className={styles.heroButton}>Стать клиентом →</button>
        </div>
          ...
          <div className={styles.descContainer}>
            <div className={styles.description}>
              <p className={styles.descriptionText}>
                Продуманная стратегия, соответствующая потребностям бизнеса, и
                надежный анализ данных являются основополагающими принципами
                нашей работы.
              </p>
            </div>
            <div className={styles.stats}>
              <h3 className={styles.statsTitle}>Некоторые цифры о нас</h3>
